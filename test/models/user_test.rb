...
class UserTest < ActiveSupport::TestCase
  def setup
    @user = User.new(first_name: "Example", last_name: "User", email: "user@example.com", password: "ramazonov", password_confirmation: "ramazonov")
  end
  ...
  test "email should be saved as lower-case" do
    mixed_case_email = "Ali@RamazonoV.com"
